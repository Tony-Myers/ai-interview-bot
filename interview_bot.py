...
def generate_response(prompt, conversation_history=None):
    try:
        ...
        system_content = (
            ...
            "focusing on AI applications. Use British English in your responses, including "
            "spellings like 'democratised'. Ensure your responses are complete and not truncated. "
            "After each user response, provide brief feedback and ask a relevant follow-up question "
            "based on their answer. Tailor your questions to the user's previous responses, avoiding "
            "repetition and exploring areas they haven't covered. Be adaptive and create a natural flow "
            "of conversation."
        )

        messages = [
            {"role": "system", "content": system_content},
            {"role": "system", "content": f"Interview topics: {', '.join(interview_topics)}"},
            *conversation_history[-6:],  # Include the last 6 exchanges for context
...
def main():
    ...
    if "current_question" not in st.session_state:
        st.session_state.current_question = (
            "Let's begin the interview. Can you please introduce yourself, your role in higher education, "
